...
def stylize(network, initial, initial_noiseblend, content,styles, preserve_colors, iterations,
    ...
    #f1 = open('style_layers_weights.txt','w')
    #f1.write(json.dumps(style_layers_weights))
    #f1.close()
    #np.save('style_layers_weights.npy', style_layers_weights)
    #style_layers_weights = {'relu1_1': 0.2, 'relu2_1': 0.2, 'relu3_1': 0.2, 'relu4_1': 0.2, 'relu5_1': 0.2}
    #np.save('style_features,.npy',style_features)
    #style_features = np.load('style_features_more.npy')
    #f2 = open('style_features_more.txt','w')
    #f2.write(json.dumps(style_features))
    #f2.close()
