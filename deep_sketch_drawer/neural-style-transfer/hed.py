...
def hed():
    ...
    #filepath = './checkpoints/HEDSeg/checkpoint.212-0.11.hdf5'
    #print(filepath)
    ...
    model.compile(loss={'o1': 'mean_squared_error',
                        'o2': 'mean_squared_error',
                        'o3': 'mean_squared_error',
                        'o4': 'mean_squared_error',
                        'o5': 'mean_squared_error',
                        'ofuse': 'mean_squared_error',
                        },
